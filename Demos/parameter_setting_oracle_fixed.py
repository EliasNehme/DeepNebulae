...
def psf_pair_parameters():
    ...
    path_masks = path_curr_dir + '/Mat_Files/masks_oracle_vipr_2105.mat'
    ...
    NFP = 3.15  # nominal focal plane in [um] (including the axial shift)
    ...
    training_data_path = path_curr_dir + "/TrainingImages_two_masks_oracle_3105/"
    ...
    results_path = path_curr_dir + "/Results_two_masks_oracle_3105/"
