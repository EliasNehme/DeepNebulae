...
def psf_pair_parameters():
    ...
    path_masks = path_curr_dir + '/Mat_Files/masks_oracle_vipr.mat'
    ...
    training_data_path = path_curr_dir + "/TrainingImages_oracle/"
    ...
    results_path = path_curr_dir + "/Results_oracle/"
