...
def psf_pair_parameters():
    ...
    zmin = 0.3  # minimal z in [um] (including the axial shift)
    zmax = 4.6  # maximal z in [um] (including the axial shift)
    NFP = 2.7  # nominal focal plane in [um] (including the axial shift)
    ...
    nsig_ratio_range = [0.55, 0.9]  # in [counts]
    ...
    nonunif_bg_minvals = [20.0, 200.0]  # in [counts]
